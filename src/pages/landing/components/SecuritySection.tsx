  ...
  return (
    <section ref={sectionRef} id="security" className="py-20 md:py-32 bg-white">
      ...
      <div className="bg-linear-to-br from-purple-50/50 to-blue-50/50 rounded-3xl p-8 md:p-12 border border-purple-100/50 flex flex-col lg:flex-row gap-12 items-center">
        <div className="timeline-group w-full lg:w-1/2">
          <h3 className="text-2xl font-bold text-gray-900 mb-10">
            전체 보안 플로우
          </h3>

          <div className="timeline-group relative pl-4 space-y-10">
            {/* 세로선 */}
            <div className="timeline-line absolute left-7.75 top-4 bottom-4 w-px bg-purple-200"></div>

            {/* 타임라인 아이템 1 */}
            <div className="timeline-item relative z-10 flex gap-6 items-start transition-transform duration-300 hover:translate-x-1">
